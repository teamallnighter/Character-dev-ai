...
const EditVersions = () => {
  ...
  const { versionsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: versionsId }));
  }, [versionsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: versionsId, data }));
...
EditVersions.getLayout = function getLayout(page: ReactElement) {
  return (
