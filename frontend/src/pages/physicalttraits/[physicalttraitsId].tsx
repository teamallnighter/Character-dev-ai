...
const EditPhysicalttraits = () => {
  ...
  const { physicalttraitsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: physicalttraitsId }));
  }, [physicalttraitsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: physicalttraitsId, data }));
...
EditPhysicalttraits.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditPhysicalttraits;
