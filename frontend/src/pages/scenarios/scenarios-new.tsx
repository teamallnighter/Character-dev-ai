...
import { create } from '../../stores/scenarios/scenariosSlice';
...
ScenariosNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_SCENARIOS'}>
      {page}
    </LayoutAuthenticated>
  );
};
