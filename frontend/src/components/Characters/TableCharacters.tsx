...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/characters/charactersSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureCharactersCols';
...
const TableSampleCharacters = ({
  ...
  useEffect(() => {
    if (charactersNotify.showNotification) {
      notify(
        charactersNotify.typeNotification,
        charactersNotify.textNotification,
      );
    }
  }, [charactersNotify.showNotification]);
  ...
  return (
    <>
      ...
      {characters && Array.isArray(characters) && !showGrid && (
        <CardCharacters
...
export default TableSampleCharacters;
